...
<table class="form-table">
    ...
    <tbody>
        ...
        <label for="identifier"><?php _e( 'Select plugin', 'license-manager-for-woocommerce' ); ?></label>
        <select id="identifier" name="plugin_name">
            <option value="dlm">
                <?php echo __('Digital License Manager', 'license-manager-for-woocommerce' ); ?>
                </option>
            </select>
        </div>
        <div class="lmfwc-tool-form-row">
            <label>
                ...
                <small style="color:red;"><?php _e( 'Preserve old IDs. If checked, your existing Digital License Manager database will be wiped to remove/free used IDs. Use this ONLY if you are absolutely sure what you are doing and if your app depend on the existing license/generator IDs.', 'license-manager-for-woocommerce' ); ?></small>
            </label>
        </div>
        ...
        <div class="lmfwc-tool-form-row">
            ...
            <button type="submit" class="button button-small button-primary"><?php _e( 'Migrate', 'license-manager-for-woocommerce' ); ?></button>
        </div> 
