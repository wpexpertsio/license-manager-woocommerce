...
<h2><?php _e( 'License Details', 'license-manager-for-woocommerce' ); ?></h2>

<table class="woocommerce-table woocommerce-table--order-details shop_table order_details">
    <tbody>
    <tr>
        <th scope="row"><?php _e( 'Product', 'license-manager-for-woocommerce' ); ?></th>
        <td>
			<?php if ( $product ): ?>
			...
			<?php else: ?>
                <span><?php echo sprintf( __( 'License #%s', 'license-manager-for-woocommerce' ), $license->getId() ); ?></span>
			<?php endif; ?>
        </td>
    </tr>
    <tr class="woocommerce-table__line-item license_keys">
        <th scope="row"><?php _e( 'License key', 'license-manager-for-woocommerce' ); ?></th>
        <td>
			<?php echo esc_html($license_key); ?>
        </td>
    </tr>
    <tr class="woocommerce-table__line-item activations_limit">
        <th scope="row"><?php _e( 'Activations', 'license-manager-for-woocommerce' ); ?></th>
        <td>
            <p>
    ...
    <!-- <tr class="woocommerce-table__line-item license_status">
        <th scope="row"><?php //_e( 'Status', 'license-manager-for-woocommerce' ); ?></th>
    ...
    <tr class="woocommerce-table__line-item valid_until">
        <th scope="row"><?php _e( 'Expires', 'license-manager-for-woocommerce' ); ?></th>
        <td class="lmfwc-inline-child lmfwc-license-status">
			<?php
        ...
        <tr class="woocommerce-table__line-item valid_until">
            <th scope="row"><?php _e( 'Certificate', 'license-manager-for-woocommerce' ); ?></th>
            <td class="lmfwc-inline-child lmfwc-license-certificate">
                ...
                <form method="post" style="display: inline-block; margin: 0;">
                        ...
                        <button class="button" type="submit"><?php _e('Download', 'license-manager-for-woocommerce');?></button>
                    </form>
            </td>
        </tr>
        <?php endif; ?>
    ...
    <p>
        <a href="<?php echo esc_url( $order->get_view_order_url() ); ?>" class="woocommerce-button button lmfwc-button"><?php _e( 'View Order', 'license-manager-for-woocommerce' ); ?></a>
    </p>
