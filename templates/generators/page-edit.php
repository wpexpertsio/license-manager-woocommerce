...
<form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
    ...
    <table class="form-table">
        <tbody>
            ...
            <!-- LICENSE TAGS -->
            <tr scope="row">
                <th scope="row"><label for="license_tags"><?php esc_html_e('License Tags', 'license-manager-for-woocommerce');?></label></th>
                <td>
                    <input name="license_tags" id="license_tags" class="regular-text" type="text" value="<?php echo esc_html($generator->getLicenseTagsAsCsv()); ?>">
                    <p class="description"><?php esc_html_e('A comma separated list of tags to identify the license keys generated by this generator.', 'license-manager-for-woocommerce');?></p>
                </td>
            </tr>
        </tbody>
    </table>
